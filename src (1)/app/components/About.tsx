          ...
          <div className="bg-surface rounded-2xl p-8 border border-border shadow-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <span className="text-text-muted">Scheduling & inbox management</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0" />
                <span className="text-text-muted">Customer complaint resolution</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0" />
                <span className="text-text-muted">CRM & Microsoft Office expertise</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0" />
                <span className="text-text-muted">Data accuracy & quality control</span>
              </div>
            </div>
