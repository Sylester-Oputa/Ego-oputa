...
const education = [
  {
    ...
    date: 'December 2022',
    description: 'Comprehensive training in virtual assistance, remote work tools, and professional administration.'
  },
  {
    type: 'certification',
    ...
    date: 'June 2017',
    description: 'Advanced customer service techniques and management strategies.'
  },
  {
    type: 'certification',
    ...
    date: 'March 2012',
    description: 'Professional certification in customer service excellence and response management.'
  },
  {
    type: 'degree',
    ...
    description: 'Advanced diploma covering business operations, management principles, and organizational behavior.'
  },
  {
    type: 'degree',
    ...
    description: 'Foundation in business administration, accounting, and management practices.'
  }
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-text-muted max-w-2xl mx-auto">
            Continuous professional development through formal education and industry certifications.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-accent-bg to-surface border border-accent/30 rounded-xl p-8 text-center">
            ...
            <p className="text-text-light text-sm mt-2">
              Recognized for exceptional dedication, work ethic, and performance during internship program
            </p>
          </div>
        </motion.div>
      </div>
