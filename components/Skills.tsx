      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-text-muted max-w-2xl mx-auto">
            A comprehensive skill set developed through diverse professional experiences and continuous
            learning in customer service and administrative support.
          </p>
        </motion.div>
              ...
              <div className="h-full bg-surface rounded-xl p-8 border border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <ul className="space-y-3">
                  {category.skills.map((skill) => {
                    const SkillIcon = iconMap[skill] || iconMap.default;
                    return (
